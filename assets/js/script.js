...
const parts = {
  ...
  currentDisplay.innerHTML = `<h3>` + city.toUpperCase() +  " " + `(${parts.month+1}/` + parts.date + `/${parts.year})` +`<img src="https://openweathermap.org/img/wn/${icon}@2x.png" width="80" height="80" alt="${weatherDescr}" ></h3> `;
  ...
  forecastOne.innerHTML = `<h3>${parts.month+1}/` + `${parts.date+1}` + `/${parts.year}</h3>` + `<img src="https://openweathermap.org/img/wn/${iconOne}@2x.png" width="60" height="60">` 
  ...
  forecastTwo.innerHTML = `<h3>${parts.month+1}/` + `${parts.date+2}` + `/${parts.year}</h3>` + `<img src="https://openweathermap.org/img/wn/${iconTwo}@2x.png" width="60" height="60">` 
  ...
  forecastThree.innerHTML = `<h3>${parts.month+1}/` + `${parts.date+3}` + `/${parts.year}</h3>` + `<img src="https://openweathermap.org/img/wn/${iconThree}@2x.png" width="60" height="60">` 
  ...
  forecastFour.innerHTML = `<h3>${parts.month+1}/` + `${parts.date+4}` + `/${parts.year}</h3>` + `<img src="https://openweathermap.org/img/wn/${iconFour}@2x.png" width="60" height="60">` 
  ...
  forecastFive.innerHTML = `<h3>${parts.month+1}/` + `${parts.date+5}` + `/${parts.year}</h3>` + `<img src="https://openweathermap.org/img/wn/${iconFive}@2x.png" width="60" height="60">` 
